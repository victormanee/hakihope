...
import { ArrowRight, BookOpen, CalendarClock, CheckCircle2, FolderLock, MapPin, MessageSquareHeart, Scale, ShieldCheck, Siren, Sparkles, Users } from "lucide-react";
//#region src/assets/hero.jpg
var hero_default = "/assets/hero-Bk5gPWXA.jpg";
//#endregion
//#region src/roots/index.tsx?tsr-split=component
var stats = [
	{
		value: "20,000+",
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [
					/* @__PURE__ */ jsx("div", { className: "absolute inset-0 -z-10 gradient-hero opacity-95" }),
					/* @__PURE__ */ jsx("div", { className: "absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top,white_0%,transparent_60%)] opacity-20" }),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5 text-gold" }), "AI-powered legal guidance for every Kenyan"]
								}),
								/* @__PURE__ */ jsxs("h1", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(Button, {
										...
										children: /* @__PURE__ */ jsxs(Link, {
											to: "/find-lawyer",
											children: ["Find a Lawyer ", /* @__PURE__ */ jsx(ArrowRight, { className: "ml-2 h-4 w-4" })]
										})
									}), /* @__PURE__ */ jsx(Button, {
										asChild: true,
										size: "lg",
										...
										children: /* @__PURE__ */ jsxs(Link, {
											to: "/ai",
											children: [/* @__PURE__ */ jsx(Sparkles, { className: "mr-2 h-4 w-4" }), " Talk to Haki AI"]
										})
									})]
								}),
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4 text-gold" }), " Law Society verified"]
										}),
										/* @__PURE__ */ jsxs("div", {
											className: "flex items-center gap-2",
											children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4 text-gold" }), " Free AI guidance"]
										}),
										/* @__PURE__ */ jsxs("div", {
											className: "flex items-center gap-2",
											children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4 text-gold" }), " English & Kiswahili"]
										})
									]
								})
							]
							...
							children: [/* @__PURE__ */ jsx("div", { className: "absolute -inset-8 bg-gold/20 blur-3xl rounded-full animate-float-slow" }), /* @__PURE__ */ jsx("img", {
								src: hero_default,
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", { className: "absolute -right-10 -top-10 h-64 w-64 rounded-full bg-gold/30 blur-3xl animate-float-slow" }), /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(Button, {
									...
									children: /* @__PURE__ */ jsxs(Link, {
										to: "/ai",
										children: [/* @__PURE__ */ jsx(Sparkles, { className: "mr-2 h-4 w-4" }), "Start with Haki AI"]
									})
								}), /* @__PURE__ */ jsx(Button, {
									asChild: true,
									size: "lg",
									...
									children: /* @__PURE__ */ jsxs(Link, {
										to: "/find-lawyer",
										children: [/* @__PURE__ */ jsx(MapPin, { className: "mr-2 h-4 w-4" }), "Browse lawyers"]
									})
								})]
							}),
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs("div", {
									className: "flex items-center gap-2",
									children: [/* @__PURE__ */ jsx(Users, { className: "h-4 w-4" }), " Trusted by 20,000+ Kenyans"]
								})
							})
						]
					})]
