import { r as HakiWordmark, t as Button } from "./button-Bcc3N_sy.js";
...
import { t as Label } from "./label-vFUv3geJ.js";
...
//#endregion
//#region src/roots/auth.tsx?tsr-split=component
function AuthPage() {
	const search = useSearch({ from: "/auth" });
	const navigate = useNavigate();
	const [mode, setMode] = useState(search.mode ?? "login");
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(SiteNav, {}), /* @__PURE__ */ jsx("main", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
							...
							/* @__PURE__ */ jsxs("form", {
								...
								children: [
									...
									/* @__PURE__ */ jsx(Button, {
										...
										disabled: busy,
										children: busy ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : mode === "signup" ? "Create account" : "Sign in"
									})
								]
							}),
							/* @__PURE__ */ jsxs("p", {
					...
					/* @__PURE__ */ jsxs("p", {
						...
						children: [/* @__PURE__ */ jsx(Scale, { className: "h-3 w-3" }), " Justice Within Reach."]
					})
				]
			})
		})]
