...
//#region src/roots/rights.tsx?tsr-split=component
var topics = [
	{
		slug: "employment",
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: filtered.map((t) => /* @__PURE__ */ jsxs("article", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs(Link, {
							...
							children: ["Ask Haki AI ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
						})
					]
				}, t.slug))
			}),
						...
						children: [
							...
							/* @__PURE__ */ jsx(Button, {
								...
								children: /* @__PURE__ */ jsxs(Link, {
									to: "/ai",
									children: [/* @__PURE__ */ jsx(Sparkles, { className: "mr-2 h-4 w-4" }), "Ask Haki AI"]
								})
							})
						]
					})
