import { a as saveMessages, i as listThreads, n as deleteThread, o as useServerFn, r as getThreadMessages, t as createThread } from "./chat.functions-C3FJuNbH.js";
import { n as cn, r as HakiWordmark, t as Button } from "./button-Bcc3N_sy.js";
import { t as supabase } from "./client-C6ZaJElq.js";
import { t as Route } from "./ai._threadId-B-jaXVny.js";
...
//#region src/roots/ai.$threadId.tsx?tsr-split=component
var SUGGESTIONS = [
...
function AiChat() {
	...
	if (!authed || !initialMessages) return /* @__PURE__ */ jsxs("div", {
		className: "min-h-screen flex items-center justify-center text-muted-foreground",
		children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4 mr-2 animate-pulse text-gold" }), " Loading Haki AI…"]
	});
	return /* @__PURE__ */ jsx(AiChatInner, {
		threadId,
		threads,
		setThreads,
		initialMessages,
			...
			children: [
				/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx(Link, {
						...
						children: /* @__PURE__ */ jsx(HakiWordmark, {})
					})
				}),
				/* @__PURE__ */ jsx("div", {
					className: "p-3",
					children: /* @__PURE__ */ jsxs(Button, {
						...
						children: [/* @__PURE__ */ jsx(Plus, { className: "h-4 w-4 mr-2" }), " New conversation"]
					})
				}),
				/* @__PURE__ */ jsx("div", {
					className: "flex-1 overflow-y-auto px-2 pb-4 space-y-1",
					children: threads.map((t) => /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs(Link, {
							...
							children: [/* @__PURE__ */ jsx(MessageSquare, { className: "h-4 w-4 shrink-0 opacity-60" }), /* @__PURE__ */ jsx("span", {
								className: "truncate",
								children: t.title
							})]
						}), /* @__PURE__ */ jsx("button", {
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs(Link, {
						...
						children: [/* @__PURE__ */ jsx(ArrowLeft, { className: "h-3 w-3" }), " Back to HakiHope"]
					})
				})
			]
		}), /* @__PURE__ */ jsxs("main", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							messages.map((m) => {
								...
								if (m.role === "user") return /* @__PURE__ */ jsx("div", {
